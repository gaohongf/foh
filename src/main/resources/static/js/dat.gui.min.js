		...
		c = {
			makeSelectable: function(b, a) {
				void 0 !== b && void 0 !== b.style && (b.onselectstart = a ? function() {
						return !1
					} : function() {}, b.style.MozUserSelect = a ? "auto" : "none", b.style
					.KhtmlUserSelect =
			...
			fakeEvent: function(b, a, c, e) {
				...
				switch (r) {
					case "MouseEvents":
						n.initMouseEvent(a, c.bubbles || !1, c.cancelable || !0, window, c.clickCount || 1, 0,
							0, c.x || c.clientX || 0, c.y || c.clientY || 0, !1,
							!1, !1, !1, 0, null);
						break;
					case "KeyboardEvents":
						...
						r(a, c.bubbles || !1, c.cancelable, window, c.ctrlKey, c.altKey, c.shiftKey, c.metaKey,
							c.keyCode, c.charCode);
						break;
					default:
			...
			bind: function(a, e, d, f) {
				a.addEventListener ? a.addEventListener(e, d, f || !1) : a.attachEvent && a.attachEvent("on" +
					e, d);
				return c
			},
			unbind: function(a, e, d, f) {
				a.removeEventListener ? a.removeEventListener(e, d, f || !1) : a.detachEvent && a.detachEvent(
					"on" + e, d);
				return c
			},
			addClass: function(a, e) {
				if (void 0 === a.className) a.className = e;
					...
					var d = a.className.split(/ +/); - 1 == d.indexOf(e) && (d.push(e), a.className = d.join(
						" ").replace(/^\s+/, "").replace(/\s+$/, ""))
				}
				return c
			},
			...
			getWidth: function(b) {
				...
				return a(b["border-left-width"]) + a(b["border-right-width"]) + a(b["padding-left"]) + a(b[
					"padding-right"]) + a(b.width)
			},
			getHeight: function(b) {
				b = getComputedStyle(b);
				return a(b["border-top-width"]) + a(b["border-bottom-width"]) + a(b["padding-top"]) + a(b[
					"padding-bottom"]) + a(b.height)
			},
...
dat.controllers.NumberController = function(f, a) {
	...
	var e = function(c, b, f) {
		...
		this.__max = f.max;
		this.__step = f.step;
		a.isUndefined(this.__step) ? this.__impliedStep = 0 == this.initialValue ? 1 : Math.pow(10, Math.floor(
			Math.log(this.initialValue) / Math.LN10)) / 10 : this.__impliedStep = this.__step;
	...
	a.extend(e.prototype, f.prototype, {
		setValue: function(a) {
			void 0 !==
				this.__min && a < this.__min ? a = this.__min : void 0 !== this.__max && a > this
				.__max && (a = this.__max);
			void 0 !== this.__step && 0 != a % this.__step && (a = Math.round(a / this.__step) * this
				.__step);
...
dat.controllers.NumberControllerBox = function(f, a, d) {
	var e = function(c, b, f) {
		...
		a.bind(this.__input, "keydown", function(a) {
			13 === a.keyCode && (n.__truncationSuspended = !0, this.blur(), n.__truncationSuspended = !
				1)
		});
		this.updateDisplay();
...
dat.controllers.BooleanController = function(f, a, d) {
	...
	d.extend(e.prototype, f.prototype, {
		...
		updateDisplay: function() {
			!0 === this.getValue() ? (this.__checkbox.setAttribute("checked", "checked"), this
				.__checkbox.checked = !0) : this.__checkbox.checked = !1;
			return e.superclass.prototype.updateDisplay.call(this)
		}
	});
	return e
	...
	return function() {
		...
		a.each(c, function(c) {
			if (c.litmus(b)) return a.each(c.conversions, function(c, f) {
				d = c.read(b);
				if (!1 === e && !1 !== d) return e = d, d.conversionName = f, d.conversion =
					c, a.BREAK
			}), a.BREAK
		});
		return e
...
dat.GUI = dat.gui.GUI = function(f, a, d, e, c, b, p, q, l, r, n, u, A, g, k) {
	...
	function L(a) {
		...
		g.bind(r, "change", function() {
			for (var b = 0; b < a.__preset_select.length; b++) a.__preset_select[b].innerHTML = a
		...
		if (x) {
			var n = function() {
				...
				b = document.getElementById("-save-locally"),
				u = document.getElementById("-local-explain");
			b.style.display = "block";
			b = document.getElementById("-local-storage");
		...
		var m = document.getElementById("-new-constructor");
	...
	var B, I = !0,
		...
		m = function(a) {
			...
			Object.defineProperties(this, {
				...
				preset: {
					...
					set: function(b) {
						...
						for (b = 0; b < this.__preset_select.length; b++) this.__preset_select[b]
							.value == this.preset && (this.__preset_select.selectedIndex = b);
						c.revert()
					}
				},
				width: {
				...
				closed: {
					...
					set: function(b) {
						a.closed = b;
						a.closed ? g.addClass(c.__ul, m.CLASS_CLOSED) : g.removeClass(c.__ul, m
							.CLASS_CLOSED);
						this.onResize();
			...
			if (k.isUndefined(a.parent)) {
				a.closed = !1;
				g.addClass(this.domElement, m.CLASS_);
			...
			a.autoPlace && (k.isUndefined(a.parent) && (I && (z = document.createElement("div"), g.addClass(z,
					""), g.addClass(z, m.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(z), I = !1
					), z.appendChild(this.domElement), g.addClass(this.domElement, m.CLASS_AUTO_PLACE)), this
				.parent || G(c, a.width));
			...
			this.saveToLocalStorageIfPossible = e = function() {
				x && "true" === localStorage.getItem(document.location.href + ".isLocal") && localStorage
					.setItem(document.location.href + ".gui", JSON.stringify(c.getSaveObject()))
			};
			c.getRoot();
			a.parent || b()
		};
	...
	k.extend(m.prototype, {
		...
		addFolder: function(a) {
			...
			this.load && this.load.folders && this.load.folders[a] && (b.closed = this.load.folders[a]
				.closed, b.load = this.load.folders[a]);
			b = new m(b);
			this.__folders[a] = b;
		...
		onResize: function() {
			...
			if (a.scrollable) {
				...
				window.innerHeight - b - 20 < c ? (g.addClass(a.domElement, m.CLASS_TOO_TALL), a.__ul
					.style.height = window.innerHeight - b - 20 + "px") : (g.removeClass(a
					.domElement, m.CLASS_TOO_TALL), a.__ul.style.height = "auto")
			}
		...
		remember: function() {
			...
			k.each(Array.prototype.slice.call(arguments), function(a) {
				0 == b.__rememberedObjects.length && L(b); - 1 == b.__rememberedObjects.indexOf(
					a) && b.__rememberedObjects.push(a)
			});
		...
		getSaveObject: function() {
			...
			0 < this.__rememberedObjects.length && (a.preset = this.preset, a.remembered || (a
				.remembered = {}), a.remembered[this.preset] = C(this));
			a.folders = {};
		...
		saveAs: function(a) {
			this.load.remembered || (this.load.remembered = {}, this.load.remembered.Default = C(this, !
				0));
	...
	'<div id="-save" class=" dialogue">\n\n  Here\'s the new load parameter for your <code>GUI</code>\'s constructor:\n\n  <textarea id="-new-constructor"></textarea>\n\n  <div id="-save-locally">\n\n    <input id="-local-storage" type="checkbox"/> Automatically save\n    values to <code>localStorage</code> on exit.\n\n    <div id="-local-explain">The values saved to <code>localStorage</code> will\n      override those passed to <code>dat.GUI</code>\'s constructor. This makes it\n      easier to work incrementally, but <code>localStorage</code> is fragile,\n      and your friends may not see the same values you do.\n      \n    </div>\n    \n  </div>\n\n</div>',
	". {\n  /** Clear list styles */\n  /* Auto-place container */\n  /* Auto-placed GUI's */\n  /* Line items that don't contain folders. */\n  /** Folder names */\n  /** Hides closed items */\n  /** Controller row */\n  /** Name-half (left) */\n  /** Controller-half (right) */\n  /** Controller placement */\n  /** Shorter number boxes when slider is present. */\n  /** Ensure the entire boolean and function row shows a hand */ }\n  . ul {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    width: 100%;\n    clear: both; }\n  ..ac {\n    position: fixed;\n    top: 0;\n    left: 0;\n    right: 0;\n    height: 0;\n    z-index: 0; }\n  .:not(.ac) . {\n    /** Exclude s in ac so that we don't hide close button */\n    overflow: hidden; }\n  .. {\n    -webkit-transition: opacity 0.1s linear;\n    -o-transition: opacity 0.1s linear;\n    -moz-transition: opacity 0.1s linear;\n    transition: opacity 0.1s linear; }\n    ...taller-than-window {\n      overflow-y: auto; }\n      ...taller-than-window .close-button {\n        opacity: 1;\n        /* TODO, these are style notes */\n        margin-top: -1px;\n        border-top: 1px solid #2c2c2c; }\n    .. ul.closed .close-button {\n      opacity: 1 !important; }\n    ..:hover .close-button,\n    .. .close-button.drag {\n      opacity: 1; }\n    .. .close-button {\n      /*opacity: 0;*/\n      -webkit-transition: opacity 0.1s linear;\n      -o-transition: opacity 0.1s linear;\n      -moz-transition: opacity 0.1s linear;\n      transition: opacity 0.1s linear;\n      border: 0;\n      position: absolute;\n      line-height: 19px;\n      height: 20px;\n      /* TODO, these are style notes */\n      cursor: pointer;\n      text-align: center;\n      background-color: #000; }\n      .. .close-button:hover {\n        background-color: #111; }\n  ..a {\n    float: right;\n    margin-right: 15px;\n    overflow-x: hidden; }\n    ..a.has-save > ul {\n      margin-top: 27px; }\n      ..a.has-save > ul.closed {\n        margin-top: 0; }\n    ..a .save-row {\n      position: fixed;\n      top: 0;\n      z-index: 1002; }\n  . li {\n    -webkit-transition: height 0.1s ease-out;\n    -o-transition: height 0.1s ease-out;\n    -moz-transition: height 0.1s ease-out;\n    transition: height 0.1s ease-out; }\n  . li:not(.folder) {\n    cursor: auto;\n    height: 27px;\n    line-height: 27px;\n    overflow: hidden;\n    padding: 0 4px 0 5px; }\n  . li.folder {\n    padding: 0;\n    border-left: 4px solid rgba(0, 0, 0, 0); }\n  . li.title {\n    cursor: pointer;\n    margin-left: -4px; }\n  . .closed li:not(.title),\n  . .closed ul li,\n  . .closed ul li > * {\n    height: 0;\n    overflow: hidden;\n    border: 0; }\n  . .cr {\n    clear: both;\n    padding-left: 3px;\n    height: 27px; }\n  . .property-name {\n    cursor: default;\n    float: left;\n    clear: left;\n    width: 40%;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n  . .c {\n    float: left;\n    width: 60%; }\n  . .c input[type=text] {\n    border: 0;\n    margin-top: 4px;\n    padding: 3px;\n    width: 100%;\n    float: right; }\n  . .has-slider input[type=text] {\n    width: 30%;\n    /*display: none;*/\n    margin-left: 0; }\n  . .slider {\n    float: left;\n    width: 66%;\n    margin-left: -5px;\n    margin-right: 0;\n    height: 19px;\n    margin-top: 4px; }\n  . .slider-fg {\n    height: 100%; }\n  . .c input[type=checkbox] {\n    margin-top: 9px; }\n  . .c select {\n    margin-top: 5px; }\n  . .cr.function,\n  . .cr.function .property-name,\n  . .cr.function *,\n  . .cr.boolean,\n  . .cr.boolean * {\n    cursor: pointer; }\n  . .selector {\n    display: none;\n    position: absolute;\n    margin-left: -9px;\n    margin-top: 23px;\n    z-index: 10; }\n  . .c:hover .selector,\n  . .selector.drag {\n    display: block; }\n  . li.save-row {\n    padding: 0; }\n    . li.save-row .button {\n      display: inline-block;\n      padding: 0px 6px; }\n  ..dialogue {\n    background-color: #222;\n    width: 460px;\n    padding: 15px;\n    font-size: 13px;\n    line-height: 15px; }\n\n/* TODO Separate style and structure */\n#-new-constructor {\n  padding: 10px;\n  color: #222;\n  font-family: Monaco, monospace;\n  font-size: 10px;\n  border: 0;\n  resize: none;\n  box-shadow: inset 1px 1px 1px #888;\n  word-wrap: break-word;\n  margin: 12px 0;\n  display: block;\n  width: 440px;\n  overflow-y: scroll;\n  height: 100px;\n  position: relative; }\n\n#-local-explain {\n  display: none;\n  font-size: 11px;\n  line-height: 17px;\n  border-radius: 3px;\n  background-color: #333;\n  padding: 8px;\n  margin-top: 10px; }\n  #-local-explain code {\n    font-size: 10px; }\n\n#dat-gui-save-locally {\n  display: none; }\n\n/**  type */\n. {\n  color: #eee;\n  font: 11px 'Lucida Grande', sans-serif;\n  text-shadow: 0 -1px 0 #111;\n  /** Auto place */\n  /* Controller row, <li> */\n  /** Controllers */ }\n  .. {\n    /** Scrollbar */ }\n    ..::-webkit-scrollbar {\n      width: 5px;\n      background: #1a1a1a; }\n    ..::-webkit-scrollbar-corner {\n      height: 0;\n      display: none; }\n    ..::-webkit-scrollbar-thumb {\n      border-radius: 5px;\n      background: #676767; }\n  . li:not(.folder) {\n    background: #1a1a1a;\n    border-bottom: 1px solid #2c2c2c; }\n  . li.save-row {\n    line-height: 25px;\n    background: #dad5cb;\n    border: 0; }\n    . li.save-row select {\n      margin-left: 5px;\n      width: 108px; }\n    . li.save-row .button {\n      margin-left: 5px;\n      margin-top: 1px;\n      border-radius: 2px;\n      font-size: 9px;\n      line-height: 7px;\n      padding: 4px 4px 5px 4px;\n      background: #c5bdad;\n      color: #fff;\n      text-shadow: 0 1px 0 #b0a58f;\n      box-shadow: 0 -1px 0 #b0a58f;\n      cursor: pointer; }\n      . li.save-row .button.gears {\n        background: #c5bdad url(data:image/png;base64,) 2px 1px no-repeat;\n        height: 7px;\n        width: 8px; }\n      . li.save-row .button:hover {\n        background-color: #bab19e;\n        box-shadow: 0 -1px 0 #b0a58f; }\n  . li.folder {\n    border-bottom: 0; }\n  . li.title {\n    padding-left: 16px;\n    background: black url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;\n    cursor: pointer;\n    border-bottom: 1px solid rgba(255, 255, 255, 0.2); }\n  . .closed li.title {\n    background-image: url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==); }\n  . .cr.boolean {\n    border-left: 3px solid #806787; }\n  . .cr.function {\n    border-left: 3px solid #e61d5f; }\n  . .cr.number {\n    border-left: 3px solid #2fa1d6; }\n    . .cr.number input[type=text] {\n      color: #2fa1d6; }\n  . .cr.string {\n    border-left: 3px solid #1ed36f; }\n    . .cr.string input[type=text] {\n      color: #1ed36f; }\n  . .cr.function:hover, . .cr.boolean:hover {\n    background: #111; }\n  . .c input[type=text] {\n    background: #303030;\n    outline: none; }\n    . .c input[type=text]:hover {\n      background: #3c3c3c; }\n    . .c input[type=text]:focus {\n      background: #494949;\n      color: #fff; }\n  . .c .slider {\n    background: #303030;\n    cursor: ew-resize; }\n  . .c .slider-fg {\n    background: #2fa1d6; }\n  . .c .slider:hover {\n    background: #3c3c3c; }\n    . .c .slider:hover .slider-fg {\n      background: #44abda; }\n",
	dat.controllers.factory = function(f, a, d, e, c, b, p) {
		...
		.controllers.BooleanController, dat.utils.common), dat.controllers.Controller, dat.controllers
	.BooleanController, dat.controllers.FunctionController, dat.controllers.NumberControllerBox, dat.controllers
	.NumberControllerSlider, dat.controllers.OptionController,
	dat.controllers.ColorController = function(f, a, d, e, c) {
		function b(a, b, d, e) {
			a.style.background = "";
			c.each(l, function(c) {
				a.style.cssText += "background: " + c + "linear-gradient(" + b + ", " + d + " 0%, " + e +
					" 100%); "
			})
		}
		...
		var q = function(f, n) {
			...
			function g() {
				var a = e(this.value);
				!1 !== a ? (t.__color.__state = a, t.setValue(t.__color.toOriginal())) : this.value = t.__color
					.toString()
			}
			...
			updateDisplay: function() {
				...
				if (!1 !== a) {
					...
					c.each(d.COMPONENTS, function(b) {
						if (!c.isUndefined(a[b]) && !c.isUndefined(this.__color.__state[b]) &&
							a[b] !== this.__color.__state[b]) return f = !0, {}
					}, this);
				...
				c.extend(this.__input.style, {
					...
					color: "rgb(" + l + "," + l + "," + l + ")",
					textShadow: this.__input_textShadow + "rgba(" + p + "," + p + "," + p +
						",.7)"
				})
			}
		});
		...
		function p(b, c, d) {
			...
			else if ("HSV" === b.__state.space) e.extend(b.__state, a.hsv_to_rgb(b.__state.h, b.__state.s, b
				.__state.v));
	...
	}(), dat.color.toString, dat.utils.common), dat.color.interpret, dat.utils.common), dat.utils
